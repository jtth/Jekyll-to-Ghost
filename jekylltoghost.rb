...
# updated by Jordan T. Thevenow-Harrison, jtth.net 2018-11-20.
  ...
  class JsonFileGenerator < Generator
    ...
    def generate(site)
      ...
      site.posts.docs.each do |post|
        ...
        process_tags(id, post.data['tags'], post.data['categories'])
        id += 1
      end
